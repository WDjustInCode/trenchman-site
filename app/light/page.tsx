...
<p className="font-bebas text-gold tracking-[0.3em] text-sm uppercase mb-6">
          ...
          <h1
            className="font-rockwell text-5xl md:text-7xl lg:text-8xl font-bold uppercase leading-none mb-8 text-deep-black"
          >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div
                key={t.name}
                className="border-2 border-gold/30 bg-white rounded-lg p-6 shadow-sm"
              >
      ...
      <footer className="bg-[#ECEAE4] border-t-2 border-gold/20 py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-end gap-10">
          ...
          <div className="flex flex-col gap-6 flex-1">
            <p className="text-deep-black/50 text-sm">Built for the Athletes Who Fight in the Trenches.</p>
            <div>
              ...
              <form className="flex gap-2 max-w-sm">
                <input
                  ...
                  className="bg-white border-2 border-gold/40 rounded px-3 py-2 text-sm flex-1 text-deep-black placeholder:text-deep-black/30 focus:outline-none focus:border-gold"
                />
                <button
                  type="submit"
                  className="font-bebas font-bold bg-gold text-white text-sm px-4 py-2 rounded hover:bg-gold/80 transition-colors uppercase tracking-wider"
                >
                  Join
                </button>
              </form>
            ...
            <div>
              ...
              <div className="flex gap-4 text-deep-black/50 text-sm">
