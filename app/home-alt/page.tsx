  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-6">
        {verticals.map((v) => (
          ...
          >
            ...
            <p className="font-novecento text-athletic-white/90 text-2xl tracking-widest mb-2 uppercase">
              {v.label}
            </p>
      ...
      <section className="bg-white/5 py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div key={t.name} className="border-2 border-gold/50 rounded-lg p-6">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <h2 className="font-novecento text-gold text-4xl tracking-widest mb-10 uppercase">
          Upcoming Camps
        </h2>
